codeunit 50104 "BSB Company Info. Wizard Meth"
{
    ...
    var
        ...
        WizardTitleTxt: label 'Title in Assited Setup List';
        WizardDescTxt: label 'Description in Assited Setup List';
    begin
    ...
    begin
        ...
        if Confirm(SetupAlreadyDoneQst, true) then begin
            Page.Run(Page::"Company Information" /*GetPageId()*/); //TODO: Might have to be be a different page (like not the wizard, but the setup page instead)
            Handled := true;
        end;
    end;
    ...
    begin
        ...
        if (Rec.Name <> '') and (Rec."E-Mail" <> '') then  //TODO: You probably are going to want to change this ;-)
